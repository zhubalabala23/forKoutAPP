...
@Composable
fun SmoothiesBlueberryScreen(onBackClick: () -> Unit) {
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.smoothies_blueberry),
                    contentDescription = "Smoothies Blueberry",
                ...
                Text(
                    ...
                    • Madu atau pemanis lainnya (opsional)
                    """.trimIndent(),
                    fontSize = 14.sp,
                    color = Color.Gray,
                    modifier = Modifier.padding(bottom = 8.dp)
                ...
                Text(
                    ...
                    3. Tambahkan madu atau pemanis lain sesuai selera.
                    4. Tuang ke dalam gelas dan sajikan segera.
                    """.trimIndent(),
                    fontSize = 14.sp,
                    color = Color.Gray,
...
fun SmoothiesBlueberryScreenPreview() {
    SmoothiesBlueberryScreen(onBackClick = {})
}
