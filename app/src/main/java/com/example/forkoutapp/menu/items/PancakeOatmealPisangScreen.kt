...
@Composable
fun PancakeOatmealPisangScreen(onBackClick: () -> Unit) {
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.pancake_oatmeal_pisang),
                    contentDescription = "Pancake Oatmeal Pisang",
                ...
                Text(
                    ...
                    2. Campurkan oatmeal, telur, susu, dan madu ke dalam pisang halus, aduk hingga rata.
                    3. Panaskan wajan anti lengket dengan sedikit minyak.
                    4. Tuang adonan pancake ke wajan, tunggu hingga matang dan berwarna keemasan di kedua sisi.
                    """.trimIndent(),
                    fontSize = 14.sp,
                    color = Color.Gray,
...
@Composable
fun PancakeOatmealPisangScreenPreview() {
    PancakeOatmealPisangScreen(onBackClick = {})
}
